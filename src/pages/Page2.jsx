...
const Page2 = () => {
    ...
    return (
        <div id='section2' className='bg-white text-center text-black p-10'>
            <h3 className='text-gray-500 text-2xl font-[font4]'>
                ©&nbsp;&nbsp;anzo.studio 2024 | designed and developed</h3>
            <div className='textAnim '>
                <h1 className='text-[42vw] leading-[45vw] text-black font-[font6]'>IMPACTFUL</h1>
            </div>
            <div className='textAnim '>
                <h1 className='text-[42vw] leading-[33vw] text-black font-[font6]'>DESIGNL</h1>
            </div>
            <div className='textAnim '>
                <h1 className='text-[42vw] leading-[33vw] text-black font-[font6]'>IS THE</h1>
            </div>
            <div className='textAnim '>
                <h1 className='text-[42vw] leading-[33vw] text-black font-[font6]'>DESIGN</h1>
            </div>
            <div className='textAnim '>
                <h1 className='text-[42vw] leading-[33vw] text-black font-[font6]'>THAT</h1>
            </div>
            <div className='textAnim '>
                {/* <canvas className='h-full w-[70%] left-1/2 -translate-y-10 -translate-x-1/2 absolute bg-green-600 '></canvas> */}
                <h1 className='text-[42vw] leading-[33vw] text-black font-[font6]'>WORKS</h1>
            </div>
